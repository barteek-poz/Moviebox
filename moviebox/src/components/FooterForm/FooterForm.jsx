...
export const FooterForm = () => {
  ...
  const validationCondition =
    (!emailValid && emailTouched) || emailValid ? true : false;
  return (
    <Form onSubmit={emailValidationHandler}>
      <div className="INPUT flex items-center gap-2.5">
        <input
        ...
        />
        <div className="BUTTON-DIV border rounded-lg border-black transition duration-300 hover:border-transparen">
